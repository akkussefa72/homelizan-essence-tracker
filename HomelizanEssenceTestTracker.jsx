  ...
  async function exportPdf() {
    ...
    try {
      ...
      function drawHeader({ compact = false } = {}) {
        ...
        doc.setDrawColor(226, 232, 240);
        const labelText = "Homelizan Essence Lab";
      ...
      for (let i = 1; i <= totalPages; i += 1) {
        ...
        doc.setFontSize(8);
        doc.setTextColor(100, 116, 139);
        doc.text("Generated by Homelizan Essence Lab", margin.left, footerY);
...
function Header({ exportJson, onOpenPdf, importJson, connectionStatus, onGoHome, onLogout, userEmail }) {
      ...
      <div>
        <div className="mb-2 flex flex-wrap items-center gap-2">
          <button
            type="button"
            onClick={onGoHome}
            className="inline-flex items-center gap-2 rounded-full border border-slate-200 bg-white px-4 py-2 text-base font-bold text-slate-700 shadow-sm transition hover:bg-slate-50 md:text-lg"
          >
            <FlaskConical className="h-5 w-5 md:h-6 md:w-6" /> Homelizan Essence Lab
          </button>
          <div
    ...
    <Card className="rounded-2xl p-6 md:p-7">
      <div className="mb-5">
        <div className="mb-2 inline-flex items-center gap-2 rounded-full border border-slate-200 bg-white px-3 py-1 text-xs font-bold text-slate-600">
          <FlaskConical className="h-4 w-4" /> Homelizan Essence Lab
        </div>
